...
theme.wallpaper                                 = theme.dir .. "/suse.jpg"
...
theme.mpd = lain.widget.mpd({
    settings = function()
        ...
        widget:set_markup(markup.font(theme.font, markup("#32D6FF", artist) .. title))
    end
})
...
local net = lain.widget.net({
    settings = function()
        ...
        -- widget:set_markup(markup.font(theme.font, markup("#7AC82E", " " .. string.format("%06.1f", net_now.received)) .. " " .. markup("#46A8C3", " " .. string.format("%06.1f", net_now.sent) .. " ")))
    end
})
